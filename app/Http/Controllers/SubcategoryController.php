...
namespace App\Http\Controllers; // Make sure this matches your structure
...
class SubcategoryController extends Controller
{
    ...
    {
        // Find the category (aka collection)
        $category = Category::with('products')->findOrFail($id);

        // Optionally, group products by subcategory if you have subcategories
